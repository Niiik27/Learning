...
def print_tab(tab_head: list, content: list, tab_name: str = "", padding: int = 1):
    """
    ...
    print()
    if tab_name:
        print(tab_name.center(len(line)), " ")
    print("_" * len(line))
    print(line.replace("-", " "))
    # print(line)
    print(field_str)
    print(line)
    """Толко здесь мы добрались до отображения данных таблицы"""
    for user_line in content:
        field_str = "|"
        for i in range(len(tab_head)):
            field: str = user_line[i]
