...
# Чтобы исключить этот массив из кода - нужно test установить в False
test = True
test_guestList = [
    {
        "nameGuest": "Николай",
...
guestList = test_guestList if test else []
menu_items = ["Добавить гостей", "Удалить гостя по имени", "Удалить гостя по номеру", "Удалить гостя по id",
              "Удалить гостя по индексу", "Удалить гостя по возрасту", "Удалить всех взрослых", "Удалить всех детей",
              "Удалить всех мужчин",
