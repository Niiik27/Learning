class User:
    ...
    def show_menu(self):
        return self.callback_menu(Utils.show(["Редактировать профиль", "Удалиться", "Стать модератором",
    ...
    def edit_me(self):
        ...
        choice = self.callback_menu(Utils.show(["Сменить имя", "Сменить фамилию", "Сменить логин",
                                                     "Сменить дату рождения", "Сменить пол", "Сменить пароль"],
